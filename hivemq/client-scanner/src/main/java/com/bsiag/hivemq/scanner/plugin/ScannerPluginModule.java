 ...
 */
@Information(name = "HiveMQ Scanner Plugin", author = "Matthias Zimmermann", version = "0.0.1-SNAPSHOT")
public class ScannerPluginModule extends HiveMQPluginModule {
